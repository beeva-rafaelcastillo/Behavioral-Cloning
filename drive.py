...
def process_images(img, x_pix, y_pix, y_crop):
    """
...
def telemetry(sid, data):
    if data:
        ...
        image_array = process_images(image_array, config.x_pix, config.y_pix, config.y_crop)
        ...
        if args.image_folder != '':
            ...
            # cv2.imwrite('{}_proc.jpg'.format(image_filename), image_array)
